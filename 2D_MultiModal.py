...
os.chdir("/home/dthomas/AD/2D_MultiModal/OASIS3/AD/")
ad_train_s = get_images(ad_sub_train_files, train=True, plane="s", slices=[68, 69, 70])
ad_train_c = get_images(ad_sub_train_files, train=True, plane="c")
ad_train_a = get_images(ad_sub_train_files, train=True, plane="a", slices=[88, 89, 90])

ad_test_s = get_images(ad_sub_test_files, plane="s", slices=[68, 69, 70], same_length=True, data_length=12)
ad_test_c = get_images(ad_sub_test_files, plane="c", same_length=True, data_length=12)
ad_test_a = get_images(ad_sub_test_files, plane="a", slices=[88, 89, 90], same_length=True, data_length=12)

os.chdir("/home/dthomas/AD/2D_MultiModal/OASIS3/CN/")
cn_train_s = get_images(cn_sub_train_files, train=True, plane="s", slices=[68, 69, 70])
cn_train_c = get_images(cn_sub_train_files, train=True, plane="c")
cn_train_a = get_images(cn_sub_train_files, train=True, plane="a", slices=[88, 89, 90])

cn_test_s = get_images(cn_sub_test_files, plane="s", slices=[68, 69, 70], same_length=True, data_length=12)
cn_test_c = get_images(cn_sub_test_files, plane="c", same_length=True, data_length=12)
cn_test_a = get_images(cn_sub_test_files, plane="a", slices=[88, 89, 90], same_length=True, data_length=12)
